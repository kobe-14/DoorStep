  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="gov.php">EMPLOYEE LOGIN</a></li> 
      </ul>
    </div>
  </div>
</nav>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
     ...
     <a href="https://www.facebook.com/Door-Step-360379484396045/">
  ...
  <div class="row">
    ...
    <div class="col-sm-7 slideanim">
        ...
        <div class="col-sm-6 form-group">
          <select class="selectpicker form-control" name="board" required>
            ...
            <optgroup label="LPG Gas">
              ...
              <option value="GAS">new connection</option>
              <option value="GAS">book a refill</option>
              <option value="GAS">change of address</option>
              <option value="GAS">Others</option>
            </optgroup>
      ...
      <div class="col-sm-6 form-group">
        ...
        <label>*Note the unique Complaint_Id to track the progress in future [ <?php echo $comp_id;?> ] .</label>
      </div>
      <div class="row"> 
        <div class="col-sm-12 form-group">
